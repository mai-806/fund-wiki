...
Память компьютера ***универсальна***. В ней ***неразличимо друг от друга*** хранятся данные и программы.
...
Канал распараллеливает процессоры, фактически делая компьютер многопроцессорным.
...
- [MIPS (2)](https://ru.wikipedia.org/wiki/MIPS_(архитектура))
...
- [Транспьютер (1)](https://ru.bmstu.wiki/Транспьютер)
